            ...
            <div className="flex items-center gap-1 bg-offwhite rounded-xl p-1 text-xs font-medium">
              <button
                ...
                className={`px-3 py-1.5 rounded-lg transition-colors ${
                  period === "monthly" ? "bg-white text-ink shadow-sm border border-border" : "text-muted hover:text-ink"
                }`}
              >
                Monthly
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-lg transition-colors ${
                  period === "annual" ? "bg-white text-ink shadow-sm border border-border" : "text-muted hover:text-ink"
                }`}
              >
                Annual
            ...
            {UPGRADE_PLANS.map(({ tier, label, monthlyPrice, annualPrice, highlights, recommended }) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    onClick={() => isCustom ? window.open("mailto:sales@visionboard.app") : handleUpgrade(tier)}
