  ...
  return (
    <section className="py-24 px-6 flex flex-col items-center text-center">
      <h2 className="text-[28px] md:text-[36px] font-extrabold tracking-[-0.02em] mb-4">
        Bring clarity to how your team plans and<br className="hidden md:block" /> executes.
      </h2>
      <p className="text-slate text-[16px] max-w-[600px] mb-16">
        Turn scattered goals, documentation, and workflows into connected<br className="hidden md:block" /> systems of delivery.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full text-left">
        ...
        <div className="bg-white border border-border p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-slate text-[14px] leading-[1.6]">
            Smarter planning, task clustering, and predictive timelines.
          </p>
        </div>
        {/* Card 2 */}
        <div className="bg-white border border-border p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-slate text-[14px] leading-[1.6]">
            Keep documentation, goals, and execution tightly linked in one workspace.
          </p>
        </div>
        {/* Card 3 */}
        <div className="bg-white border border-border p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
          ...
          <p className="text-slate text-[14px] leading-[1.6]">
            End-to-end team visibility, metrics, and execution status.
          </p>
        </div>
      </div>
    </section>
